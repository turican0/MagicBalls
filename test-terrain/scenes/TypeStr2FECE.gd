...
@export var level_graphics_type: int = 0

# Offset 0x0005 (5)
# uint8_t byte_0x2FED3;
@export var byte_2FED3: int = 0
...
@export var word_2FED5: int = 0

# Offset 0x0009 (9)
# int16_t word_0x2FED7;
@export var word_2FED7: int = 0

# Offset 0x000B (11)
# int8_t array_0x2FED9[8];
@export var array_2FED9: PackedByteArray = PackedByteArray() # Měla by mít délku 8
...
@export var first_seed_position: int = 0
...
@export var first_seed_height: int = 0
...
@export var dword_2FEF5: int = 0

# Offset 0x002B (43)
# uint16_t word_0x2FEF9;
@export var word_2FEF9: int = 0
