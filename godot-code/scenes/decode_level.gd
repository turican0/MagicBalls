...
#WHITE-ZANZAMAR #e0e0e8 #a4b0f0
#RED-NYMPHUR #fc1414 #c40808
#VIOLET-JARK #985c84 #542848
#BLUE-BELIX #486490 #304860
#GREEN-RAHN #305828 #24401c
...
func getInputs():
	...
	var m_x = clamp((real_mouse_pos.x / screen_size.x) * SCREEN_WIDTH, 1, SCREEN_WIDTH - 2)
	var m_y = clamp((real_mouse_pos.y / screen_size.y) * SCREEN_HEIGHT, 1, SCREEN_HEIGHT - 2)
	input_state = {
