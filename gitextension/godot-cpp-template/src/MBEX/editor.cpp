		...
		if (lenx > leny) {
			...
			for (float actx = startx; abs(endx - actx) > 1.5; actx += stepx) {
				...
				if (around) {
					...
					if (acty < -fixy)
						acty += sizemap;
					if (actx > -fixx + sizemap)
						actx -= sizemap;
					if (acty > -fixy + sizemap)
						acty -= sizemap;
				}
...
void fillterrain(kiss_terrain *terrain, SDL_Surface *mapsurface, float zoom, int beginx, int beginy) {
	...
	{
		type_entity_0x30311 actfeat = temparray_0x30311[i];
		if ((actfeat.DisId > 0) && (((actfeat.type_0x30311 == 0xa) && (actfeat.subtype_0x30311 == 0x01)) || ((actfeat.type_0x30311 == 0xa) && (actfeat.subtype_0x30311 == 0x05)) || ((actfeat.type_0x30311 == 0xa) && (actfeat.subtype_0x30311 == 0x2d)))) {
...
static void terrain_feat_append(kiss_textbox *textbox, kiss_vscrollbar *vscrollbar1) {
	...
	for (int i = first_terrain_feature; i < 0x4B0; i++) {
		...
		if (temparray_0x30311_inactive[i])
			temp[strlen(temp) - 1] = 'I'; //set last char as inactive
		if (temparray_0x30311_selected[i])
			temp[strlen(temp) - 2] = 'S'; //set last char as inactive
...
*/
static void SaveLevelFile(char const text[], char fullPath[PATH_MAX_LENGTH]) {
		...
		switch (*(int16_t *)hex4edit1feat.valueadress) {
			case 2: {
				...
				for (int i = 0; i < max_subtype_buttons; i++) {
					buttons[i].normalimg = img_none;
					buttons[i].prelightimg = img_none;
					buttons[i].activeimg = img_none;
				}
				buttons[0].normalimg = img_type02_00;
				buttons[0].prelightimg = img_type02_00;
				buttons[0].activeimg = img_type02_00;
				buttons[29].normalimg = img_type02_1D;
				buttons[29].prelightimg = img_type02_1D;
				buttons[29].activeimg = img_type02_1D;
				buttons[2].normalimg = img_type02_02;
				buttons[2].prelightimg = img_type02_02;
				buttons[2].activeimg = img_type02_02;
				buttons[3].normalimg = img_type02_03;
				buttons[3].prelightimg = img_type02_03;
				buttons[3].activeimg = img_type02_03;
				buttons[4].normalimg = img_type02_04;
				buttons[4].prelightimg = img_type02_04;
				buttons[4].activeimg = img_type02_04;
				buttons[5].normalimg = img_type02_04;
				buttons[5].prelightimg = img_type02_04;
				buttons[5].activeimg = img_type02_04;
				buttons[7].normalimg = img_type02_07;
				buttons[7].prelightimg = img_type02_07;
				buttons[7].activeimg = img_type02_07;
				buttons[8].normalimg = img_type02_08;
				buttons[8].prelightimg = img_type02_08;
				buttons[8].activeimg = img_type02_08;
				break;
			}
			case 5: {
				window_selectsubtype.visible = 1;
				...
				buttons[29].normalimg = img_type05_1D;
				buttons[29].prelightimg = img_type05_1D;
				buttons[29].activeimg = img_type05_1D;
				buttons[2].normalimg = img_type05_02;
				buttons[2].prelightimg = img_type05_02;
				buttons[2].activeimg = img_type05_02;
				buttons[3].normalimg = img_type05_03;
				buttons[3].prelightimg = img_type05_03;
				buttons[3].activeimg = img_type05_03;
				buttons[4].normalimg = img_type05_04;
				buttons[4].prelightimg = img_type05_04;
				buttons[4].activeimg = img_type05_04;
				buttons[9].normalimg = img_type05_09;
				buttons[9].prelightimg = img_type05_09;
				buttons[9].activeimg = img_type05_09;
				buttons[13].normalimg = img_type05_0D;
				buttons[13].prelightimg = img_type05_0D;
				buttons[13].activeimg = img_type05_0D;
				buttons[17].normalimg = img_type05_11;
				buttons[17].prelightimg = img_type05_11;
				buttons[17].activeimg = img_type05_11;
				buttons[19].normalimg = img_type05_13;
				buttons[19].prelightimg = img_type05_13;
				buttons[19].activeimg = img_type05_13;
			...
			case 0xa: {
				...
				buttons[5].normalimg = img_trigger;
				buttons[5].prelightimg = img_trigger;
				buttons[5].activeimg = img_trigger;
				buttons[6].normalimg = img_type0A_06;
				buttons[6].prelightimg = img_type0A_06;
				buttons[6].activeimg = img_type0A_06;
				buttons[22].normalimg = img_type0A_16;
				buttons[22].prelightimg = img_type0A_16;
				buttons[22].activeimg = img_type0A_16;
				buttons[29].normalimg = img_type0A_1D;
				buttons[29].prelightimg = img_type0A_1D;
				buttons[29].activeimg = img_type0A_1D;
				buttons[39].normalimg = img_type0A_27;
				buttons[39].prelightimg = img_type0A_27;
				buttons[39].activeimg = img_type0A_27;
				buttons[45].normalimg = img_castle;
				buttons[45].prelightimg = img_castle;
				buttons[45].activeimg = img_castle;
				buttons[59].normalimg = img_type0A_3B;
				buttons[59].prelightimg = img_type0A_3B;
				buttons[59].activeimg = img_type0A_3B;
				buttons[60].normalimg = img_type0A_3C;
				buttons[60].prelightimg = img_type0A_3C;
				buttons[60].activeimg = img_type0A_3C;
				break;
			}
		}
	}
		...
		if (*(int16_t *)hex4edit1feat.valueadress == 0x0A)
			switch (*(int16_t *)hex4edit2feat.valueadress) {
				case 0x2d: {
					...
					buttons[1].normalimg = img_type0A_2D_01;
					buttons[1].prelightimg = img_type0A_2D_01;
					buttons[1].activeimg = img_type0A_2D_01;
					buttons[2].normalimg = img_type0A_2D_02;
					buttons[2].prelightimg = img_type0A_2D_02;
					buttons[2].activeimg = img_type0A_2D_02;
					buttons[3].normalimg = img_type0A_2D_03;
					buttons[3].prelightimg = img_type0A_2D_03;
					buttons[3].activeimg = img_type0A_2D_03;
					buttons[4].normalimg = img_type0A_2D_04;
					buttons[4].prelightimg = img_type0A_2D_04;
					buttons[4].activeimg = img_type0A_2D_04;
					buttons[5].normalimg = img_type0A_2D_05;
					buttons[5].prelightimg = img_type0A_2D_05;
					buttons[5].activeimg = img_type0A_2D_05;
					buttons[6].normalimg = img_type0A_2D_06;
					buttons[6].prelightimg = img_type0A_2D_06;
					buttons[6].activeimg = img_type0A_2D_06;
					buttons[7].normalimg = img_type0A_2D_07;
					buttons[7].prelightimg = img_type0A_2D_07;
					buttons[7].activeimg = img_type0A_2D_07;
					buttons[17].normalimg = img_type0A_2D_11;
					buttons[17].prelightimg = img_type0A_2D_11;
					buttons[17].activeimg = img_type0A_2D_11;
					buttons[18].normalimg = img_type0A_2D_12;
					buttons[18].prelightimg = img_type0A_2D_12;
					buttons[18].activeimg = img_type0A_2D_12;
					buttons[19].normalimg = img_type0A_2D_13;
					buttons[19].prelightimg = img_type0A_2D_13;
					buttons[19].activeimg = img_type0A_2D_13;
					buttons[20].normalimg = img_type0A_2D_14;
					buttons[20].prelightimg = img_type0A_2D_14;
					buttons[20].activeimg = img_type0A_2D_14;
					buttons[21].normalimg = img_type0A_2D_15;
					buttons[21].prelightimg = img_type0A_2D_15;
					buttons[21].activeimg = img_type0A_2D_15;
					buttons[22].normalimg = img_type0A_2D_16;
					buttons[22].prelightimg = img_type0A_2D_16;
					buttons[22].activeimg = img_type0A_2D_16;
					buttons[23].normalimg = img_type0A_2D_17;
					buttons[23].prelightimg = img_type0A_2D_17;
					buttons[23].activeimg = img_type0A_2D_17;
					buttons[24].normalimg = img_type0A_2D_18;
					buttons[24].prelightimg = img_type0A_2D_18;
					buttons[24].activeimg = img_type0A_2D_18;
					buttons[25].normalimg = img_type0A_2D_19;
					buttons[25].prelightimg = img_type0A_2D_19;
					buttons[25].activeimg = img_type0A_2D_19;
					buttons[26].normalimg = img_type0A_2D_1A;
					buttons[26].prelightimg = img_type0A_2D_1A;
					buttons[26].activeimg = img_type0A_2D_1A;
					buttons[27].normalimg = img_type0A_2D_1B;
					buttons[27].prelightimg = img_type0A_2D_1B;
					buttons[27].activeimg = img_type0A_2D_1B;
					buttons[28].normalimg = img_type0A_2D_1C;
					buttons[28].prelightimg = img_type0A_2D_1C;
					buttons[28].activeimg = img_type0A_2D_1C;
					buttons[29].normalimg = img_type0A_2D_1D;
					buttons[29].prelightimg = img_type0A_2D_1D;
					buttons[29].activeimg = img_type0A_2D_1D;
					buttons[30].normalimg = img_type0A_2D_1E;
					buttons[30].prelightimg = img_type0A_2D_1E;
					buttons[30].activeimg = img_type0A_2D_1E;
					buttons[31].normalimg = img_type0A_2D_1F;
					buttons[31].prelightimg = img_type0A_2D_1F;
					buttons[31].activeimg = img_type0A_2D_1F;

					buttons[32].normalimg = img_type0A_2D_20;
					buttons[32].prelightimg = img_type0A_2D_20;
					buttons[32].activeimg = img_type0A_2D_20;
					buttons[33].normalimg = img_type0A_2D_21;
					buttons[33].prelightimg = img_type0A_2D_21;
					buttons[33].activeimg = img_type0A_2D_21;
					buttons[34].normalimg = img_type0A_2D_22;
					buttons[34].prelightimg = img_type0A_2D_22;
					buttons[34].activeimg = img_type0A_2D_22;
					buttons[35].normalimg = img_type0A_2D_23;
					buttons[35].prelightimg = img_type0A_2D_23;
					buttons[35].activeimg = img_type0A_2D_23;
					buttons[36].normalimg = img_type0A_2D_24;
					buttons[36].prelightimg = img_type0A_2D_24;
					buttons[36].activeimg = img_type0A_2D_24;
					buttons[37].normalimg = img_type0A_2D_25;
					buttons[37].prelightimg = img_type0A_2D_25;
					buttons[37].activeimg = img_type0A_2D_25;
					buttons[38].normalimg = img_type0A_2D_26;
					buttons[38].prelightimg = img_type0A_2D_26;
					buttons[38].activeimg = img_type0A_2D_26;
					buttons[39].normalimg = img_type0A_2D_27;
					buttons[39].prelightimg = img_type0A_2D_27;
					buttons[39].activeimg = img_type0A_2D_27;
					buttons[40].normalimg = img_type0A_2D_28;
					buttons[40].prelightimg = img_type0A_2D_28;
					buttons[40].activeimg = img_type0A_2D_28;
					buttons[41].normalimg = img_type0A_2D_29;
					buttons[41].prelightimg = img_type0A_2D_29;
					buttons[41].activeimg = img_type0A_2D_29;
					buttons[42].normalimg = img_type0A_2D_2A;
					buttons[42].prelightimg = img_type0A_2D_2A;
					buttons[42].activeimg = img_type0A_2D_2A;
					buttons[43].normalimg = img_type0A_2D_2B;
					buttons[43].prelightimg = img_type0A_2D_2B;
					buttons[43].activeimg = img_type0A_2D_2B;
					buttons[44].normalimg = img_type0A_2D_2C;
					buttons[44].prelightimg = img_type0A_2D_2C;
					buttons[44].activeimg = img_type0A_2D_2C;
					buttons[45].normalimg = img_type0A_2D_2D;
					buttons[45].prelightimg = img_type0A_2D_2D;
					buttons[45].activeimg = img_type0A_2D_2D;
					buttons[46].normalimg = img_type0A_2D_2E;
					buttons[46].prelightimg = img_type0A_2D_2E;
					buttons[46].activeimg = img_type0A_2D_2E;
					buttons[47].normalimg = img_type0A_2D_2F;
					buttons[47].prelightimg = img_type0A_2D_2F;
					buttons[47].activeimg = img_type0A_2D_2F;

					buttons[48].normalimg = img_type0A_2D_30;
					buttons[48].prelightimg = img_type0A_2D_30;
					buttons[48].activeimg = img_type0A_2D_30;
					buttons[49].normalimg = img_type0A_2D_31;
					buttons[49].prelightimg = img_type0A_2D_31;
					buttons[49].activeimg = img_type0A_2D_31;
					buttons[50].normalimg = img_type0A_2D_32;
					buttons[50].prelightimg = img_type0A_2D_32;
					buttons[50].activeimg = img_type0A_2D_32;
					buttons[51].normalimg = img_type0A_2D_33;
					buttons[51].prelightimg = img_type0A_2D_33;
					buttons[51].activeimg = img_type0A_2D_33;
					buttons[52].normalimg = img_type0A_2D_34;
					buttons[52].prelightimg = img_type0A_2D_34;
					buttons[52].activeimg = img_type0A_2D_34;
					buttons[53].normalimg = img_type0A_2D_35;
					buttons[53].prelightimg = img_type0A_2D_35;
					buttons[53].activeimg = img_type0A_2D_35;
					buttons[54].normalimg = img_type0A_2D_36;
					buttons[54].prelightimg = img_type0A_2D_36;
					buttons[54].activeimg = img_type0A_2D_36;
					buttons[55].normalimg = img_type0A_2D_37;
					buttons[55].prelightimg = img_type0A_2D_37;
					buttons[55].activeimg = img_type0A_2D_37;
					buttons[56].normalimg = img_type0A_2D_38;
					buttons[56].prelightimg = img_type0A_2D_38;
					buttons[56].activeimg = img_type0A_2D_38;
					buttons[57].normalimg = img_type0A_2D_39;
					buttons[57].prelightimg = img_type0A_2D_39;
					buttons[57].activeimg = img_type0A_2D_39;
					buttons[58].normalimg = img_type0A_2D_3A;
					buttons[58].prelightimg = img_type0A_2D_3A;
					buttons[58].activeimg = img_type0A_2D_3A;
					buttons[59].normalimg = img_type0A_2D_3B;
					buttons[59].prelightimg = img_type0A_2D_3B;
					buttons[59].activeimg = img_type0A_2D_3B;
					buttons[60].normalimg = img_type0A_2D_3C;
					buttons[60].prelightimg = img_type0A_2D_3C;
					buttons[60].activeimg = img_type0A_2D_3C;
					buttons[61].normalimg = img_type0A_2D_3D;
					buttons[61].prelightimg = img_type0A_2D_3D;
					buttons[61].activeimg = img_type0A_2D_3D;
					buttons[62].normalimg = img_type0A_2D_3E;
					buttons[62].prelightimg = img_type0A_2D_3E;
					buttons[62].activeimg = img_type0A_2D_3E;
					buttons[63].normalimg = img_type0A_2D_3F;
					buttons[63].prelightimg = img_type0A_2D_3F;
					buttons[63].activeimg = img_type0A_2D_3F;

					buttons[64].normalimg = img_type0A_2D_40;
					buttons[64].prelightimg = img_type0A_2D_40;
					buttons[64].activeimg = img_type0A_2D_40;
					buttons[65].normalimg = img_type0A_2D_41;
					buttons[65].prelightimg = img_type0A_2D_41;
					buttons[65].activeimg = img_type0A_2D_41;
					buttons[66].normalimg = img_type0A_2D_42;
					buttons[66].prelightimg = img_type0A_2D_42;
					buttons[66].activeimg = img_type0A_2D_42;
					buttons[68].normalimg = img_type0A_2D_44;
					buttons[68].prelightimg = img_type0A_2D_44;
					buttons[68].activeimg = img_type0A_2D_44;
					buttons[69].normalimg = img_type0A_2D_45;
					buttons[69].prelightimg = img_type0A_2D_45;
					buttons[69].activeimg = img_type0A_2D_45;
					buttons[70].normalimg = img_type0A_2D_46;
					buttons[70].prelightimg = img_type0A_2D_46;
					buttons[70].activeimg = img_type0A_2D_46;
					buttons[71].normalimg = img_type0A_2D_47;
					buttons[71].prelightimg = img_type0A_2D_47;
					buttons[71].activeimg = img_type0A_2D_47;
					buttons[72].normalimg = img_type0A_2D_48;
					buttons[72].prelightimg = img_type0A_2D_48;
					buttons[72].activeimg = img_type0A_2D_48;
					buttons[73].normalimg = img_type0A_2D_49;
					buttons[73].prelightimg = img_type0A_2D_49;
					buttons[73].activeimg = img_type0A_2D_49;
					buttons[74].normalimg = img_type0A_2D_4A;
					buttons[74].prelightimg = img_type0A_2D_4A;
					buttons[74].activeimg = img_type0A_2D_4A;
					buttons[75].normalimg = img_type0A_2D_4B;
					buttons[75].prelightimg = img_type0A_2D_4B;
					buttons[75].activeimg = img_type0A_2D_4B;
...
void SetSelected(kiss_terrain *terrain, type_entity_0x30311 *temp303array, bool *selecedarray) {
	...
	if ((count == 0)) {
		if (prevselect && (xmin == xmax) && (ymin == ymax))
			return;
...
int kiss_terrain_event(kiss_terrain *terrain, SDL_Event *event, int *draw, int mousex, int mousey, type_entity_0x30311 *temp303array, bool *selecedarray) {
	if (!terrain || !terrain->visible || !event)
		return 0;
	...
	if (event->type == SDL_MOUSEWHEEL && kiss_pointinrect(mousex, mousey, &terrain->rect)) {
		*draw = 1;
		...
		if ((*terrain->terrainzoom) > 64)
			(*terrain->terrainzoom) = 64;
		...
		*draw = 1;
		...
		if (terrain->movingactive == 1) {
			...
			*draw = 1;
			return 13;
		} else if (terrain->movingactive == 2) {
			terrain->posx = (event->button.x - terrain->rect.x) / (*terrain->terrainzoom * 2) + *terrain->terrainbeginx;
			terrain->posy = (event->button.y - terrain->rect.y) / (*terrain->terrainzoom * 2) + *terrain->terrainbeginy;
			SetSelected(terrain, temp303array, selecedarray);
			terrain->prelight = 1;
		...
		switch (actsubtype) {
			case 0x2d: {
				switch (actsubsubtype) {
					case 0x01:
						*img = &img_type0A_2D_01;
						break;
					case 0x02:
						*img = &img_type0A_2D_02;
						break;
					case 0x03:
						*img = &img_type0A_2D_03;
						break;
					case 0x04:
						*img = &img_type0A_2D_04;
						break;
					case 0x05:
						*img = &img_type0A_2D_05;
						break;
					case 0x06:
						*img = &img_type0A_2D_06;
						break;
					case 0x07:
						*img = &img_type0A_2D_07;
						break;
					case 0x11:
						*img = &img_type0A_2D_11;
						break;
					case 0x12:
						*img = &img_type0A_2D_12;
						break;
					case 0x13:
						*img = &img_type0A_2D_13;
						break;
					case 0x14:
						*img = &img_type0A_2D_14;
						break;
					case 0x15:
						*img = &img_type0A_2D_15;
						break;
					case 0x16:
						*img = &img_type0A_2D_16;
						break;
					case 0x17:
						*img = &img_type0A_2D_17;
						break;
					case 0x18:
						*img = &img_type0A_2D_18;
						break;
					case 0x19:
						*img = &img_type0A_2D_19;
						break;
					case 0x1A:
						*img = &img_type0A_2D_1A;
						break;
					case 0x1B:
						*img = &img_type0A_2D_1B;
						break;
					case 0x1C:
						*img = &img_type0A_2D_1C;
						break;
					case 0x1D:
						*img = &img_type0A_2D_1D;
						break;
					case 0x1E:
						*img = &img_type0A_2D_1E;
						break;
					case 0x1F:
						*img = &img_type0A_2D_1F;
						break;
					case 0x20:
						*img = &img_type0A_2D_20;
						break;
					case 0x21:
						*img = &img_type0A_2D_21;
						break;
					case 0x22:
						*img = &img_type0A_2D_22;
						break;
					case 0x23:
						*img = &img_type0A_2D_23;
						break;
					case 0x24:
						*img = &img_type0A_2D_24;
						break;
					case 0x25:
						*img = &img_type0A_2D_25;
						break;
					case 0x26:
						*img = &img_type0A_2D_26;
						break;
					case 0x27:
						*img = &img_type0A_2D_27;
						break;
					case 0x28:
						*img = &img_type0A_2D_28;
						break;
					case 0x29:
						*img = &img_type0A_2D_29;
						break;
					case 0x2A:
						*img = &img_type0A_2D_2A;
						break;
					case 0x2B:
						*img = &img_type0A_2D_2B;
						break;
					case 0x2C:
						*img = &img_type0A_2D_2C;
						break;
					case 0x2D:
						*img = &img_type0A_2D_2D;
						break;
					case 0x2E:
						*img = &img_type0A_2D_2E;
						break;
					case 0x2F:
						*img = &img_type0A_2D_2F;
						break;
					case 0x30:
						*img = &img_type0A_2D_30;
						break;
					case 0x31:
						*img = &img_type0A_2D_31;
						break;
					case 0x32:
						*img = &img_type0A_2D_32;
						break;
					case 0x33:
						*img = &img_type0A_2D_33;
						break;
					case 0x34:
						*img = &img_type0A_2D_34;
						break;
					case 0x35:
						*img = &img_type0A_2D_35;
						break;
					case 0x36:
						*img = &img_type0A_2D_36;
						break;
					case 0x37:
						*img = &img_type0A_2D_37;
						break;
					case 0x38:
						*img = &img_type0A_2D_38;
						break;
					case 0x39:
						*img = &img_type0A_2D_39;
						break;
					case 0x3A:
						*img = &img_type0A_2D_3A;
						break;
					case 0x3B:
						*img = &img_type0A_2D_3B;
						break;
					case 0x3C:
						*img = &img_type0A_2D_3C;
						break;
					case 0x3D:
						*img = &img_type0A_2D_3D;
						break;
					case 0x3E:
						*img = &img_type0A_2D_3E;
						break;
					case 0x3F:
						*img = &img_type0A_2D_3F;
						break;
					case 0x40:
						*img = &img_type0A_2D_40;
						break;
					case 0x41:
						*img = &img_type0A_2D_41;
						break;
					case 0x42:
						*img = &img_type0A_2D_42;
						break;
					case 0x44:
						*img = &img_type0A_2D_44;
						break;
					case 0x45:
						*img = &img_type0A_2D_45;
						break;
					case 0x46:
						*img = &img_type0A_2D_46;
						break;
					case 0x47:
						*img = &img_type0A_2D_47;
						break;
					case 0x48:
						*img = &img_type0A_2D_48;
						break;
					case 0x49:
						*img = &img_type0A_2D_49;
						break;
					case 0x4A:
						*img = &img_type0A_2D_4A;
						break;
					case 0x4B:
						*img = &img_type0A_2D_4B;
						break;
				}
				break;
			}
...
int main_x() {
	...
	kiss_button button_type[16];
	for (int i = 0; i < 16; i++)
		button_type[i] = { 0 };
	kiss_button button_subtype[64];
	for (int i = 0; i < 16; i++)
		button_subtype[i] = { 0 };
	kiss_button button_subsubtype[128];
	for (int i = 0; i < 16; i++)
		button_subsubtype[i] = { 0 };
	kiss_button button_selectdraw[7];
	for (int i = 0; i < 16; i++)
		button_subsubtype[i] = { 0 };
	kiss_button button_check[16];
	for (int i = 0; i < 16; i++)
		button_check[i] = { 0 };
	...
	button_selectcheck.activeimg = img_search;
	button_selectcheck.prelightimg = img_search;
	...
	button_selecttype.activeimg = img_search;
	button_selecttype.prelightimg = img_search;

	kiss_button_new(&button_selectsubtype, &window2, (char *)" ", window2.rect.x + kiss_up.w + 270, window2.rect.y + 30, &img_search);
	button_selectsubtype.activeimg = img_search;
	button_selectsubtype.prelightimg = img_search;

	kiss_button_new(&button_selectsubsubtype, &window2, (char *)" ", window2.rect.x + kiss_up.w + 270, window2.rect.y + 150, &img_search);
	button_selectsubsubtype.activeimg = img_search;
	button_selectsubsubtype.prelightimg = img_search;
	...
	button_type[0].activeimg = img_none;
	button_type[0].prelightimg = img_none;
	...
	button_type[1].activeimg = img_none;
	button_type[1].prelightimg = img_none;
	...
	button_type[2].activeimg = img_rock;
	button_type[2].prelightimg = img_rock;
	...
	button_type[3].activeimg = img_player;
	button_type[3].prelightimg = img_player;
	...
	button_type[4].activeimg = img_none;
	button_type[4].prelightimg = img_none;
	...
	button_type[5].activeimg = img_creature;
	button_type[5].prelightimg = img_creature;
	...
	button_type[6].activeimg = img_none;
	button_type[6].prelightimg = img_none;
	...
	button_type[7].activeimg = img_weather;
	button_type[7].prelightimg = img_weather;
	...
	button_type[8].activeimg = img_none;
	button_type[8].prelightimg = img_none;
	...
	button_type[9].activeimg = img_none;
	button_type[9].prelightimg = img_none;
	...
	button_type[10].activeimg = img_type2D;
	button_type[10].prelightimg = img_type2D;
	...
	button_type[11].activeimg = img_trigger;
	button_type[11].prelightimg = img_trigger;
	...
	button_type[12].activeimg = img_none;
	button_type[12].prelightimg = img_none;
	...
	button_type[13].activeimg = img_none;
	button_type[13].prelightimg = img_none;
	...
	button_type[14].activeimg = img_spell;
	button_type[14].prelightimg = img_spell;
	...
	button_type[15].activeimg = img_spellB;
	button_type[15].prelightimg = img_spellB;
	...
	button_check[0].activeimg = img_check00;
	button_check[0].prelightimg = img_check00;
	...
	button_check[1].activeimg = img_none;
	button_check[1].prelightimg = img_none;
	...
	button_check[2].activeimg = img_none;
	button_check[2].prelightimg = img_none;
	...
	button_check[3].activeimg = img_check03;
	button_check[3].prelightimg = img_check03;
	...
	button_check[4].activeimg = img_none;
	button_check[4].prelightimg = img_none;
	...
	button_check[5].activeimg = img_check05;
	button_check[5].prelightimg = img_check05;
	...
	button_check[6].activeimg = img_none;
	button_check[6].prelightimg = img_none;
	...
	button_check[7].activeimg = img_check07;
	button_check[7].prelightimg = img_check07;
	...
	button_check[8].activeimg = img_check08;
	button_check[8].prelightimg = img_check08;
	...
	button_check[9].activeimg = img_check09;
	button_check[9].prelightimg = img_check09;
	...
	while (!quit) {
		...
		while (SDL_PollEvent(&e)) {
			...
			if (kiss_hex4edit_event(&hex4edit1, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit2, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit3, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit4, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit5, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit6, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit7, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit8, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit9, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit10, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit11, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit12, &e, &draw) > 10)
				changed = true;

			if (kiss_hex4edit_event(&hex4edit13, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit14, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit15, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit16, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit17, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit18, &e, &draw) > 10)
				changed = true;
			if (kiss_hex4edit_event(&hex4edit19, &e, &draw) > 10)
				changed = true;

			if (kiss_hex2edit_event(&hex2edit20, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit21, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit22, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit23, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit24, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit25, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit26, &e, &draw) > 10)
				changed = true;
			if (kiss_hex2edit_event(&hex2edit27, &e, &draw) > 10)
				changed = true;

			if (select1_event(&select1, &e, &select2, &select3, &select4, &draw))
				zoomchanged = true;
			if (select2_event(&select2, &e, &select1, &select3, &select4, &draw))
				zoomchanged = true;
			if (select3_event(&select3, &e, &select1, &select2, &select4, &draw))
				zoomchanged = true;
			if (select4_event(&select4, &e, &select1, &select2, &select3, &draw))
				zoomchanged = true;
			//window2
			...
			if (kiss_hex4edit_event(&hex4edit3feat, &e, &draw) > 10)
				changed2 = true;
			if (kiss_hex4edit_event(&hex4edit4feat, &e, &draw) > 10)
				changed2 = true;
			if (kiss_hex4edit_event(&hex4edit5feat, &e, &draw) > 10)
				changed2 = true;
			if (kiss_hex4edit_event(&hex4edit6feat, &e, &draw) > 10)
				changed2 = true;
			if (kiss_hex4edit_event(&hex4edit7feat, &e, &draw) > 10)
				changed2 = true;
			if (kiss_hex4edit_event(&hex4edit8feat, &e, &draw) > 10) {
				set_button_image_subsubtype(&act_img_subsubtype, *(int16_t *)hex4edit1feat.valueadress, *(int16_t *)hex4edit2feat.valueadress, *(int16_t *)hex4edit8feat.valueadress);
				changed2 = true;
			}
			if (kiss_hex4edit_event(&hex4edit9feat, &e, &draw) > 10)
				changed2 = true;
			if (kiss_hex4edit_event(&hex4edit10feat, &e, &draw) > 10)
				changed2 = true;

			//window3
			if (kiss_hex2edit_event(&hex2edit1check, &e, &draw) > 10)
				changed3 = true;
			if (kiss_hex4edit_event(&hex4edit2check, &e, &draw) > 10)
				changed3 = true;
			if (kiss_hex4edit_event(&hex4edit3check, &e, &draw) > 10)
				changed3 = true;
			if (kiss_hex4edit_event(&hex4edit4check, &e, &draw) > 10)
				changed3 = true;
		...
		for (int i = 0; i < 16; i++)
			kiss_button_draw(&button_type[i], editor_renderer);

		kiss_window_draw(&window_selectsubtype, editor_renderer);
		for (int i = 0; i < max_subtype_buttons; i++)
			kiss_button_draw(&button_subtype[i], editor_renderer);

		kiss_window_draw(&window_selectsubsubtype, editor_renderer);
		for (int i = 0; i < max_subsubtype_buttons; i++)
			kiss_button_draw(&button_subsubtype[i], editor_renderer);

		kiss_window_draw(&window_selectdraw, editor_renderer);
		for (int i = 0; i < max_selectdraw_buttons; i++)
			kiss_button_draw(&button_selectdraw[i], editor_renderer);

		for (int i = 0; i < 9; i++)
			kiss_button_draw(&button_check[i], editor_renderer);
