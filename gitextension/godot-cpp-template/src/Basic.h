...
extern std::array<uint8_t*, 256> x_DWORD_DDF50_texture_adresses; // weak
...
int32_t x_tolower(int32_t);// weak
...
int sub_7FCB0_draw_text_with_border(char* textString, int32_t a3, int32_t a4, int a5, uint8_t a6, unsigned __int8 a7, uint32_t a8);//560cb0
