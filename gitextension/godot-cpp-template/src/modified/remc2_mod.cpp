...
bool NewGameDialog_77350_mod_Begin()
{
	...
	if (LoadLevelNumber_D419C <= -1) {
		...
		//skip SetCursor_8CD27((*filearray_2aa18c[filearrayindex_POINTERSDATTAB].posistruct)[0]);
...
void sub_7C120_draw_bitmap_640_modX(int16_t posx, int16_t posy, bitmap_pos_struct_t tempstr, __int16 posx2, __int16 posy2, int index,int type=0) //25d120
{
...
void sub_7E840_draw_textbox_with_line_modX(type_E24BCx *a1x, __int16 posx2, __int16 posy2) {
	...
	if (x_D41A0_BYTEARRAY_4_struct.showHelp_10 == 1) {
		...
		if (switchbit == 2) {
			...
			while (mapMenuButtons_E23E0[v6y].byte_25) {
				//if (mapMenuButtons_E23E0[v6y].byte_23 && mapMenuButtons_E23E0[v6y].byte_22 == (int)(unk_E2516[8 + 9 * unk_17DBA8str.unk_17DBB4] >> 8))// x_BYTE_E2527[18 * *((signed __int16 *)a2 + 6)] )
				if (mapMenuButtons_E23E0[v6y].canSelect_23 && mapMenuButtons_E23E0[v6y].byte_22 == str_E2516[unk_17DBA8str.unk_17DBB4].byte_16) // x_BYTE_E2527[18 * *((signed __int16 *)a2 + 6)] )
				{
		...
		if (mapMenuButtons_E23E0[i].canSelect_23) {
			...
			if (InRegion_7B200(&mapMenuButtons_E23E0[i], x_DWORD_17DE38str.x_DWORD_17DEE4_mouse_positionx, x_DWORD_17DE38str.x_DWORD_17DEE6_mouse_positiony)) {
				if (x_DWORD_17DE38str.x_WORD_17DEEE_mouse_buttons & 1) {
					...
					do //adress 25f4e7
					{
						if (str_E2516[index2].byte_17 == mapMenuButtons_E23E0[i].byte_22) {
							memset(textBoxStr, 0, 36);
...
void sub_7FCB0_draw_text_with_border_modX(char *textString, int32_t a3, int32_t a4, int a5, uint8_t a6, unsigned __int8 a7, uint32_t a8, int textIndex) {
...
void DrawText_80C30_mod(__int16 posX, __int16 posY, __int16 addWidth) //261c30
{
	...
	if (x_DWORD_17DE28str.DisplayLevelDescriptionText_17DE34 != 3 && x_D41A0_BYTEARRAY_4_struct.OptionsSettingFlag_24 & 0x40 && !IsPlayingCDTrack_17E09D) {
		...
		if (index2 != -1)
			PlayCDTrackSegmentNumber_86EB0(index2, 0, 0);
	}
}

void DrawText_7FB90_modX(char *textbuffer, int16_t posx, int16_t posy, uint8_t color) //260b90
{
						...
						if (jx) {
							...
							*a5 = 3;
							if (jx < 24) {
								...
								x_DWORD_17DE28str.DisplayLevelDescriptionText_17DE34 = ((x_D41A0_BYTEARRAY_4_struct.OptionsSettingFlag_24 & 0x40) != 0) + 1;
...
bool NewGameDialog_77350_mod(type_menuButtons_E1F84 *a1x) //258350
{
	...
	if (LoadLevelNumber_D419C <= -1) {
		...
		SetCursor_8CD27((*filearray_2aa18c[filearrayindex_POINTERSDATTAB].posistruct)[0]); //dword_EB394
